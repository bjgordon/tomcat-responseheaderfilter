...
If you're using tanuki wrapper open your wrapper.conf and add the following entries:
 ...
 wrapper.java.classpath.4=/usr/share/java/commons-lang.jar
 wrapper.java.classpath.5=/usr/share/java/tomcat6-servlet-2.5-api.jar
 wrapper.java.classpath.6=/usr/ahre/java/response-header-filter-1.0.jar
